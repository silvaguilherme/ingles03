<x-app-layout>
    ...
    <div class="py-2 bg-alura-dark">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-1.5 mb-3">
                <div class="alura-card rounded shadow p-2 border-l-4 border-blue-500">
                    <div class="flex items-center justify-between gap-2">
                        <div class="min-w-0">
                            <p class="text-alura-text-muted text-xs font-medium">Cards</p>
                            <p class="text-lg font-bold text-alura-text mt-0">{{ $totalCards }}</p>
                        </div>
                ...
                <div class="alura-card rounded shadow p-2 border-l-4 border-green-500">
                    <div class="flex items-center justify-between gap-2">
                        <div class="min-w-0">
                            <p class="text-alura-text-muted text-xs font-medium">Estudados</p>
                            <p class="text-lg font-bold text-alura-text mt-0">{{ $cardsStudied }}</p>
                        </div>
                ...
                <div class="alura-card rounded shadow p-2 border-l-4 border-orange-500">
                    <div class="flex items-center justify-between gap-2">
                        <div class="min-w-0">
                            <p class="text-alura-text-muted text-xs font-medium">Revisar</p>
                            <p class="text-lg font-bold text-alura-text mt-0">{{ $cardsDueReview }}</p>
                        </div>
                ...
                <div class="alura-card rounded shadow p-2 border-l-4 border-purple-500">
                    <div class="flex items-center justify-between gap-2">
                        <div class="min-w-0">
                            <p class="text-alura-text-muted text-xs font-medium">Decks</p>
                            <p class="text-lg font-bold text-alura-text mt-0">{{ count($decksWithProgress) }}</p>
                        </div>
                        <svg class="w-6 h-6 text-purple-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
